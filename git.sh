...
git config --global color.diff-highlight.newNormal    "#76946A"
git config --global color.diff-highlight.newHighlight "#76946A #2B3328 bold"
...
git config --global color.diff.new        "#76946A bold"
